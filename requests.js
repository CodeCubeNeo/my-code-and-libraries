...
// in the options you can specify the url hash, http headers, responseType (one from XMLHttpRequest responseTypes) and url or body data (depending on the req method)
// supported methods:
